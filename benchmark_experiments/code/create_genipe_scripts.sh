dir="/gwasurvivr_manuscript/benchmark_experiments/code/genipe_impute";
output_dir="/gwasurvivr_manuscript/benchmark_experiments/results/genipe";
for m in `seq 1 3`;
do
...
#SBATCH --output=${output_dir}/genipe/results/log/genipe_n${j}_p${k}_rep${m}_%j.out
#SBATCH --error=${output_dir}/genipe/results/log/genipe_n${j}_p${k}_rep${m}_%j.err
#Get date and time
tstart=\$(date +%s)
