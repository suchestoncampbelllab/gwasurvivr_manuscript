dir="/gwasurvivr_manuscript/benchmark_experiments/data/code/gwastools_impute";
output_dir="/gwasurvivr_manuscript/benchmark_experiments/results/gwastools";
for m in `seq 1 3`;
do
...
SCRIPT=/gwasurvivr_manuscript/benchmark_experiments/code
############################
module load R
