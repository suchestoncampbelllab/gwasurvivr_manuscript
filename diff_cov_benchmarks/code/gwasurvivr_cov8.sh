...
#SBATCH --job-name=gwasurvivr_n5000_p100000_cov8
#SBATCH --output=/gwasurvivr_mnauscript/diff_cov_experiments/results/gwasurvivr/log/gwasurvivr_n5000_p100000_cov8_%j.out
#SBATCH --error=/gwasurvivr_mnauscript/diff_cov_experiments/results/gwasurvivr/log/gwasurvivr_n5000_p100000_cov8_%j.err
...
R --file=$SCRIPT/run_gwasurvivr_covs.R -q --args \
	...
	output /gwasurvivr_mnauscript/diff_cov_experiments/results/gwasurvivr/n5000_p100000_cov8.gwasurvivr \
	chunk.size 10000 \
	ncores $SLURM_NTASKS \
	covariate cov8
