...
#SBATCH --job-name=sv_n5000_p100000_cov12
#SBATCH --output=/gwasurvivr_mnauscript/diff_cov_experiments/results/sv/log/sv_n5000_p100000_cov12_%A_%a.out
#SBATCH --error=/gwasurvivr_mnauscript/diff_cov_experiments/results/sv/log/sv_n5000_p100000_cov12_%A_%a.err
#SBATCH --array=1-100
...
mono /util/academic/survivalGWAS/SurvivalGWAS_SV_v1.3.2/survivalgwas-sv.exe \
	...
	-t=time \
	-c=event \
	-cov=sex,age,DrugTxYes,pc1,pc2,pc3,pc4,pc5,pc6,pc7,pc8,pc9 \
	-chr=18 \
	-lstart=$nstart \
	-lstop=$nstop \
	-method="cox" \
	-p="onlysnp" \
	-o=/gwasurvivr_mnauscript/diff_cov_experiments/results/sv/n5000_p100000_cov12_${SLURM_ARRAY_TASK_ID}.sv
