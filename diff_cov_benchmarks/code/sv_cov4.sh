...
#SBATCH --job-name=sv_n5000_p100000_cov4
#SBATCH --output=/gwasurvivr_mnauscript/diff_cov_experiments/results/sv/log/sv_n5000_p100000_cov4_%A_%a.out
#SBATCH --error=/gwasurvivr_mnauscript/diff_cov_experiments/results/sv/log/sv_n5000_p100000_cov4_%A_%a.err
#SBATCH --array=1-100
...
mono /util/academic/survivalGWAS/SurvivalGWAS_SV_v1.3.2/survivalgwas-sv.exe \
	...
	-t=time \
	-c=event \
	-cov=sex,age,DrugTxYes,pc1 \
	-chr=18 \
	-lstart=$nstart \
	-lstop=$nstop \
	-method="cox" \
	-p="onlysnp" \
	-o=/gwasurvivr_mnauscript/diff_cov_experiments/results/sv/n5000_p100000_cov4_${SLURM_ARRAY_TASK_ID}.sv
