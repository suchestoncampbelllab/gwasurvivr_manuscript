...
#SBATCH --job-name=genipe_n5000_p100000_cov8
#SBATCH --output=/gwasurvivr_manuscript/diff_cov_benchmarks/results/genipe/log/genipe_n5000_p100000_cov8_%j.out
#SBATCH --error=/gwasurvivr_manuscript/diff_cov_benchmarks/results/genipe/log/genipe_n5000_p100000_cov8_%j.err
...
imputed-stats cox \
    ...
    --out /gwasurvivr_manuscript/benchmark_experiments/genipe/results/n5000_p100000_cov8.genipe \
    --nb-process $SLURM_NTASKS \
    --nb-lines 100000 \
    --prob 0 \
    --maf 0 \
    --gender-column sex \
    --covar age,DrugTxYes,sex,pc1,pc2,pc3,pc4,pc5 \
    --sample-column ID_2 \
    --time-to-event time \
    --event event
